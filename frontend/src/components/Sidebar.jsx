...
const Sidebar = () => {
  ...
  const navItems = [
    { name: "Dashboard", path: "/dashboard-overview", icon: "m4 6h16M4 12h16M4 18h7" },
    { name: "Projects", path: "/dashboard", icon: "m8 10 4 4 4-4" }, // Make Kanban the active project view
  ...
  return (
    <div className="w-64 h-screen bg-[#0F172A] text-[#94A3B8] flex flex-col fixed left-0 top-0">
      {/* Logo Area */}
      <div className="p-6">
        <Link to="/dashboard" className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-white font-bold text-lg leading-tight">TaskFlow Pro</h1>
            <p className="text-xs text-[#64728B]">Enterprise Plan</p>
          </div>
        </Link>
      </div>
      ...
      <div className="px-4 mb-6">
        <button className="w-full bg-gradient-to-r from-[#6161FF] to-[#FF00D9] text-white py-2.5 rounded-lg text-sm font-medium hover:opacity-90 transition-opacity flex items-center justify-center gap-2">
